            ...
            <form id="regForm">
                ...
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <img src="" id="image" style="height:48px;float: right;" alt="">
                    </div>
                </div>
                <div class="clearfix"></div>
                <button type="button" id="regBtn" class="btn btn-danger" style="margin-top:20px;width: 30%;margin-left: 10px;">立即注册</button>
                <a href="${pageContext.request.contextPath}/back/login.jsp" class="btn btn-info" style="margin-top:20px;width: 30%;margin-left: 30px;">返回登录</a>
            </form>
